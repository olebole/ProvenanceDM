...
Thanks to: Karl Kosak, Johann Bregeon, Julien Lefaucheur and Jose Enrique Ruiz 
...
%\input{serialization-descriptions}
...
\section{Full UML diagram}
\label{sec:fulldiagram}

\begin{figure}[hbt]
\centering
\includegraphics[width=1.0\textwidth]{PR2-fullview-20190507.png}
