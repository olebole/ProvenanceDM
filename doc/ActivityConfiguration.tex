...
\textbf{value} & (value dependent)  &  the value, type depends on \attribute{ParameterDescription.valueType} \\
\bottomrule
\end{tabulary}
...
default       & (value dependent) & the default value of the parameter, type depends on \attribute{valueType}\\
\bottomrule
\end{tabulary}
...
If a \class{ParameterDescription} instance is defined, the \attribute{name} attribute of the related \class{Parameter} instances must point to the \attribute{name} attribute of this \class{ParameterDescription} instance.
...
If a \class{ConfigFileDescription} instance is defined, the \attribute{name} attribute of the related \class{ConfigFile} instances must point to the \attribute{name} attribute of this \class{ConfigFileDescription} instance.
